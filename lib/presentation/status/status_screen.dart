        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                  width: double.maxFinite, height: MediaQuery.sizeOf(context).height / 2.h, child: const CustomStatusTiles(isExist: false)),
  ...
  ListTile _buildStatusListTile() {
    return ListTile(
        ...
        subtitle: Text("tap to add status update",
            style: TextStyle(fontSize: 15.sp, color: ConstantColor.textColor, fontWeight: FontWeight.w700)));
  }
}
