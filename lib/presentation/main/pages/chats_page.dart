...
import 'package:whatsapp_clone_app/presentation/chat/chat_screen.dart';
      ...
      child: ListTile(
        ...
        trailing: Column(
          ...
          children: [
            ...
            CircleAvatar(
                radius: 12.h, backgroundColor: ConstantColor.secondaryColor, child: const Text("2", style: TextStyle(color: Colors.white)))
          ],
        ),
